...
from ares.api.routes.agent import router as agent_router
...
from ares.api.routes.resources import router as resources_router
from ares.api.routes.storage import router as storage_router
from ares.api.routes.storage_operations import router as storage_operations_router
...
api_router.include_router(boot_router, prefix="/boot", tags=["boot"])
